...
plot <- df %>%
  ...
  labs(title = "Efficiency Assumption Scenario 1 (patrol 2kt, transit 8kt)")+
...
plot <- df2 %>%
  ...
  labs(title = "Endurance Scenario 1 (patrol 2kt, transit 8kt)")+
...
plot <- df %>%
  ...
  labs(title = "Range Scenario 1 (patrol 2kt, transit 8kt)")
ggplotly(plot) %>%
...
plot <- df %>%
  ...
  labs(title = "Power Scenario 1 (patrol 2kt, transit 8kt)")
ggplotly(plot) %>%
