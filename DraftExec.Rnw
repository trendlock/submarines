...
\includegraphics[width=.8\textwidth]{JetHighFlow.png}
...
\begin{figure}[h]
\captionsetup{width=.8\textwidth}
\includegraphics[width=.8\textwidth]{JetLowFlow.png}
