...
{\huge \textsf{A reply to the Government's response}}
\vskip\baselineskip
{\huge \textsf{to the question of the pumpjet}}
\vskip\baselineskip
\noindent
...
\vskip\baselineskip
\textsf{Prepared for Submarines for Australia}
...
In January 2018, I produced a detailed report\parencite{morrison2018}, commissioned by Gary Johnston from Submarines for Australia, in order to examine the question of the efficiency of a pumpjet.   Pumpjets, whilst common on nuclear submarines which can operate at high speeds (above 25kt) for sustained periods, are generally not used on diesel-electric submarines, which need to operate at very low speeds (around 10kt during transit, and under 5kt during combat operations).  Considerable emphasis had been placed on the significance of the pumpjet proposed in the successful French bid made by DCNS (now Naval Group) for Australia's Future Submarine.  I concluded that an inevitable characteristic of pumpjets - directly necessitated by the characteristics which gave them good acoustic performance at high speeds - was very low propulsive performance (efficiency) at low speeds.  This would mean that a diesel-electric submarine would suffer poorer range and endurance, and significantly worse dived range and endurance, as well as a worse indiscretion ratio due to the use of a pumpjet.  Given the profound importance of these characteristics to all diesel-electric submarines, as well as the elevated importance of range and endurance to the Australian requirement, it appears from these results that a pumpjet can be safely regarded as entirely unsuitable for Australia's Future Submarine.

On June 7 2018, I appeared as a witness before the Senate Economic References Committee \parencite{SEN2018morrison}, where I defended and expanded upon my results.  My evidence was presented in the presence of senior officials from Defence and Naval Group, who steadfastly refused to comment.  The Committee directed Defence to provide a written response to my paper prior to the conclusion of the Inquiry into the Future of Australia's Naval Shipbuilding Industry (scheduled for the 27th of June) which they finally produced in mid September.  Submarines for Australia had already commissioned me to write a subsequent report in reply to the responses that had appeared in answers to Questions on Notice in Parliament, and also in the media.  With Defence's submission finally received, this paper is in a position to comprehensively assess the totality of the arguments put by Defence against the conclusions of my previous paper.

With the receipt of the written report it has become clear that Defence has no credible basis for rejecting the findings of my research.  Their arguments are so completely incongruous with the most essential (and relatively obvious) physical principles, it appears that Defences has quite thoroughly disgraced their technical credibility in making this response.

Their claim that pumpjets can be efficient across the entire speed range, including patrol speed, are based on the assumption that the efficiency of propulsors operating on fully-submerged bodies (like submarines) is ``essentially constant over speed"\parencite{defence2018} \parencite{kerr2018}.  This is supported by the argument that efficiency relates to resistance, and that resistance faced by underwater bodies does not vary with speed, since it is only wave-making resistance (encountered by vessels on the surface) that is the speed-dependent component of resistance.

This is simply untrue.  It is a bizarre, irrational claim with no basis whatsoever in physics.  It is frankly bewildering that such a claim could be made, given how easily it's falsehood can be established by even moderate research, or simple logic.  If it were true, then submarines and torpedoes would be able to elevate their speed without increased resistance, and consequently reach any speed they might choose without requiring larger motors, or more fuel, and hence attain virtually unlimited range.

The truth is that the resistance of submerged bodies in almost all relevant real-world situations scales with velocity squared.  (Wave-making resistance is in \textit{addition} to this.) This exponential increase in resistance explains why conventional submarines slow to extremely low speeds in order to conserve energy when dived, and has been used by other respected physicists discussing this topic \parencite{davies2017} as well as essentially all scientific literature involving hydrodynamics.  It also explains why a propulsor, which must faces one hundred times as much resistance when travelling at 30kt as it does at 3kt on the same vessel, functions differently in these regimes, and consequently has a different efficiency.

For Defence, assisted by Defence Science and Technology Group (DSTG), to believe that the relationship between drag resistance and speed under-water is anywhere near constant is an extremely shocking revelation.  In the scientific community, it would be just as strange to hear that a dentist with teenage children believes in the tooth-fairy.  Not only is is their job to know better, but abundant life experience would have continually proven otherwise.

An unavoidable conclusion is that claims made by Defence to Parliament in response to Questions on Notice claiming that the pumpjet can be efficient across the entire speed range are entirely baseless and extremely misleading.

Such a revelation necessitates a further question regarding whether such misleading claims where made out of complete ignorance and incompetence, or whether they were deliberately intended to deceive.  As can be seen from the chronology of public comments which this report details, it is difficult to see how Defence could hold such a naive and embarrassing view after having their attention drawn to the opposing evidence multiple times, and devoted considerable resources to understanding the relevant technologies.  In 2012 Senator Johnston challenged RADM Moffit directly as to why research money was even being directed towards pumpjets, given how obviously inappropriate they were for our use, but RADM Moffit insisted they would still do the work required to better their understanding\parencite{SE2012moffit}. In 2017 Defence revealed that a 99 page report was commissioned on pumpjets as part of \$214 million in `de-risking' research, and that over a million dollars had subsequently been spent on pumpjet research specifically.

Notwithstanding the improbability that the incompetence of Defence is so completely pervasive that all of this research failed to yield even a basic understanding of hydrodynamics, the probability that the necessary degree of ignorance has occurred through arrangement rather than accident can be most firmly established by three simple propositions:

\begin{enumerate}
\item  \textbf{The French know the answer.}  As one of only two countries in the world who have designed and produced both pumpjets and propellers, nuclear and conventional submarines, and fitted and operated each type of propulsor on both types of submarines, there can be no doubt whatsoever that Naval Group and the French Government do have a well-formed opinion about the performance of pumpjets on diesel-electric submarines.  They would have extensive operational performance data from their in-service SSBNs which use the pumpjet.  They would have extremely detailed modelling, and tank-test results from the pumpjet from the almost-complete Barracuda class, which has an identical hull diameter to the proposed Shortfin Barracuda. They would have extensive operational performance data from their own Rubis Class nuclear submarines, which still use propellers, as well as the results of earlier tests, confirmed to have occurred by Naval Group Officials\parencite{SEN2018morrison}, where a pumpjet was fitted to a diesel-electric Agosta Class submarine.  That they have adequate performance data from all the necessary reference points to assess the likely performance of the proposed pumpjet on our own submarine is entirely beyond dispute.

\item  \textbf{The French gave the answer to the Australians.} It would naturally be a matter of profound neglect on the part of Australian officials to fail to ascertain the necessary performance data - both acoustic and propulsive efficiency - from the French during a Competitive Evaluation Process.  Any doubt that this occurred, however, can be reliably dismissed on account of public statements made by DCNS during the CEP claiming proudly that ``The stealth and hydrodynamic performances of pump jet propulsion are of course classified and in Australia known only to DCNS and the Australian Government."\parencite{costello2016}. Given RADM Sammut's repeated statements \parencite{SEN2016sammut} \parencite{SEN2017hanson} to Senate Estimates that  ``the way in which technical data would be transferred to Australia and the way in which intellectual property would be managed" was one of the reasons that DCNS was selected as design partner, and DCNS's clear pride in  ``the offer from France to transfer to Australia sovereign control and use of pump-jet propulsion technology"\parencite{costello2016} there can also be no doubt that after the conclusion of the CEP and the commencement of design, absolutely nothing would have prevented Australia seeking further performance details or reference points, or even assistance in interpretation in the case that the information provided in the CEP was found to be in any way insufficient or unclear.

\item \textbf{The Australians can't produce the answer, and are instead denying one exists.} Instead of countering my report by claiming that they have examined test results provided by the French, (or from their own research and modelling) which demonstrates that pumpjet efficiency does not decline at low speeds as I have concluded, Defence is now disgracing themselves with a series of entirely implausible arguments which amount to arguing that no adequate reference point really exists, and therefore the answer cannot be known.  In simple terms, those arguments are:

\begin{itemize}

\item \textbf{The hull and the pumpjet need to be `tuned' to each other.} This is the longest-running argument, which has been made repeatedly by RADM Sammut in sequential years\parencite{sammut2017}\parencite{bergmann2018}, in answers to Questions on Notice[\ref{QON1}], and by Chief of Maritime at DSTG \parencite{kerr2018} as well as the final response to my paper\parencite{defence2018}.  It constitutes an attempt to deny that other nuclear submarines, including the nuclear Barracuda, serve as an adequate reference point to assess the probable performance of the pumpjet on the Shortfin Barracuda.  It requires an enormous contortion of logic in order to argue that the approximate performance of the pumpjet we will have can't be known on account of the hull.  It would be equally fair to argue that one cannot know how a pair of shoes would perform in a given circumstance without simultaneously tuning them to a pair of socks. Whilst it is true that the two have to work in close conjunction with each other and a particularly poor match might impair performance, it is necessary (and sufficient) during concept design to assume that a competent (normally ideal) match is made in order to assess the overall suitability of the system.  The implausibility of this argument is further cemented by just how much emphasis has been given to the fact that the Shortfin Barracuda will have \textit{exactly the same} diameter hull as the nuclear cousin from which it is derived\parencite{SEN2017hanson}\parencite{kerr2017}, which ought to make adjustments to the pumpjet on account of the hull entirely unwarranted.

\item \textbf{The weight of the pumpjet makes it inappropriate for smaller diesel-electric submarines, but not for larger ones.} This argument has only occurred recently, first made by former CEO of Naval Group Australia Brent Clark\parencite{clark2018}, (to which I responded\parencite{morrison2018b}), and then later explained in more detail by Chief of Maritime at DSTG Dr David Kershaw\parencite{kerr2018}.  It is an attempt to deny that any other non-nuclear submarines, including every operating class in existence (none of which have adopted pumpjets) constitute an adequate reference point for assessing the likely performance of the pumpjet on our future non-nuclear submarine.  It is demonstrably ridiculous, since if a smaller submarine could not maintain proper balance and buoyancy with a heavy pumpjet attached to its tail, then the the submarine would be doomed to either tail-stand or sink, which would amount to a catastrophic failure if ever such a submarine were to detach from its moorings. That this is not the case is amply demonstrated by the fact that both the French and Russians have succeeded in fitting pumpjets to small submarines, and such catastrophes were avoided.  The Russian test boat, B-871 `Alrosa' still operates regularly in the Black Sea.\footnote{The Black Sea is an inland sea about half the size of NSW, which shares borders only with Romania, Bulgaria, Georgia, Ukraine and Turkey. Russia operates a fleet of seven Kilo Class Submarines in the Black Sea, mostly out of Sevastopol, the port which it acquired control of through the 2014 annexation of Crimea.  The Black Sea might thus be described appropriately as a `Russian Lake', where the endurance and range penalties imposed on Alrosa by the pumpjet might be tolerated.  None of the Kilo Class Submarines produced since Alrosa have a pumpjet, and none of the 15 Russian Kilo Class submarines operating in the Northern, Pacific, or Baltic Fleets have pumpjets.}

\item \textbf{The resistance of submerged bodies is constant with speed, unlike that of ships who encounter wave-making resistance.}  This is the most recent, and the most utterly and demonstrably false argument, made both by Dr David Kershaw of DSTG in an interview with Australian Defence Magazine\parencite{kerr2018}, and in Defence's considered written submission to the Senate Economic References Committee\parencite{defence2018}.  It constitutes a clearly desperate and severely embarrassing attempt to dismiss the volumous literature assessing the efficiency of propulsors as a function of `advance ratio' ($J$, a unitless metric designed specifically for the purpose of making comparisons possible across vessels encountering different levels of resistance from any source including speed) simply because such literature is often associated with ships.  It is true that ships have the \textit{additional} resistance of wave-making resistance that submarines do not, but for most displacement vessels operating at design speed (and certainly all submarines) pressure drag and skin friction on the submerged part of the hull tend to dominate, both of which scale with velocity squared.  Consequently, the `advance ratio' (how far forward through the water a propeller moves for a given degree of rotation) changes substantially with speed, for a submarine just as it does for a surface ship, and efficiency consequently changes along with this.

\end{itemize}

\end{enumerate}

As noted by Andrew Davies when he contemplated the possibility that ``Naval Group is pulling the wool over the eyes of a clueless Commonwealth" with the pump jet, extraordinary claims require extraordinary evidence\parencite{davies2017}.  There can be no doubt that such extraordinary evidence of cluelessness has now been supplied by the Department of Defence. There can also be no doubt that Naval Group's proposal in the Competitive Evaluation Process (CEP) to which the pumpjet was ``integral"\parencite{guillou2017} was disingenuous at best, and quite possibly fraudulent.

However, the impression of cluelessness is so severe, it is difficult to reconcile with the adamant insistence of competence and confidence in the pumpjet choice, given by multiple senior officials in the face of sustained questions backed up by substantial evidence on numerous occasions.\footnote{When Senator Carr was confirming in a public hearing with Kim Gillis (Head of Capability and Sustainment Group), that he was able to review my report and respond to my earlier evidence quickly before the close of the inquiry, Gillis replied ``The only caveat I'll put on any response we make is that the one thing we do really well is detailed engineering analysis."} It is so extraordinary that it demands the question of whether the appointed officials who represent the Commonwealth are indeed `clueless'.  The alternative proposition is that officials in the Navy and Department of Defence are complicit or co-operating with Naval Group and the French Government to pull the wool over the eyes of a clueless Parliament, including the Cabinet (who signed off on the decision), and the Australian public at large.

The gravity of reaching such a conclusion is difficult to understate, given the likely nature of the motives which would attend to such a decision.  One would presume that one would not advance into the public arena a submarine design which was known to be nonviable, and lead to deep embarrassment and ridicule if subjected to thorough scrutiny, unless the real motive for the design or partner choice was even less capable of withstanding public scrutiny.  The possibility that this is the case must be considered very seriously, given the difficulty of reconciling recent events with the counter-factual proposition:

After the initial publication of my first report, three Questions on Notice were asked by Senator Ketter, specifically referencing my report[\ref{QON1}, \ref{QON2}, \ref{QON3}].  Whilst Defence avoided answering all of them directly, one of them was particularly brazenly side-stepped.  Asked ``Is Defence still confident that Naval Group still hold the opinion that the pump-jet is well suited to diesel-electric submarines?" Defence merely reiterated their intent is to use the pumpjets as offered, strictly avoiding mentioning anyone's opinion, either their own or Naval Group's.  If the answer actually was what we would all assume it should be, that would have been a very easy question to answer directly.  A simple `yes' would be sufficient.  If the answer was `no', then we must assume that at the time of writing (presumably before the return date of 3 April, though Defence isn't always timely) that Defence had an inkling (at the very least) of what Naval Group undoubtedly knew all along - that pumpjets are entirely unsuitable for diesel-electric submarines.  In avoiding answering the question directly, Defence was not just misleading the Parliament, but clearly acting to shelter Naval Group from subsequent questions about fraudulent or misleading conduct during the CEP.

Giving Defence the most generous possible interpretation, one might allow the possibility that Defence was just coming to grips with being completely hood-winked during the CEP by their chosen design-partner, and perhaps felt that their wrath at being deliberately deceived ought not be publicly vented, or at least not at this stage.  News that negotiations have largely broken-down\parencite{greene2018} could well be considered in this light.  One might, at a stretch, allow that maintaining the opportunity for the partner to save-face was still a useful bargaining-chip that our Defence chiefs to use in order to bring a potentially treacherous contractor to heel. (Presumably in addition to a range of contractual penalties, as well as the commercial leverage the Commonwealth would have by being able to re-introduce competition into the design process as many have suggested ought be done in any case \parencite{stanford2017}, or simply not proceed to a build contract on completion of the design.)

However, at least at the time of the final public hearing for the Inquiry into the Future of Naval Shipbuilding in Australia \parencite{SEN2018morrison}, it appeared that Defence was moving in exactly the opposite direction.  Senators on the committee were deeply concerned with establishing just how early it was during or after the CEP process that Defence agreed (with Naval Group) that they would be the \textit{builder} of the submarines, not just the design partner as previously assumed, and that Australian Submarine Corporation was to be consumed by DCNS.\footnote{On the 20th of June 2017 the Acting CEO of DCNS, Brent Clark stated that ``from our perspective, ASC will be consumed by DCNS."}  A further topic of substantial interest was whether the Strategic Partnering Agreement (SPA) that was currently being negotiated would commit the Commonwealth to use DCNS as the \textit{builder} of \textit{all 12} submarines. It was clear to anyone in the room that Defence's responses implied that it was very likely that this would be the case.

Taken together, these observations paint a very different picture of the intended direction of Defence's relationship with DCNS.  Defence appeared to be excluding two options which might have been assumed as likely or even default courses of action for a government seeking to minimise risk and retain some sovereign control over a crucial defence project:  either that the chosen foreign design partner would be expected to work with a local builder (one would assume ASC) to deliver the build, or that allocation of the actual build contract (or contracts, in the case they proceed in blocks) be left until a later stage when the detailed design (or preceding block of submarines) was closer to being completed satisfactorily.  As members of the committee were clearly conscious, the apparent course taken by defence would effectively wipe out the opportunity for any competitive tension (or external technical scrutiny) at any stage of the \$79 billion five-decade project within the first two years of a five-year detailed design phase.  Why Defence might be contemplating eliminating, rather than exercising opportunities to increase competitive tension at a time when it was becoming clear that the pumpjet proposal was disingenuous is extremely unclear.

In light of these events, I find the most plausible explanation to be the worst:
\begin{itemize}
\item The propulsive performance of pumpjets do indeed decline to very low efficiencies at low speeds, making them completely unsuitable for diesel-electric submarines which are forced to operate almost entirely at such speeds.  This is particularly the case for a submarine required to operate over large distances, such as that demanded by the Australian requirement.
\item Some group of individuals, including senior French officials from Naval Group as well as the Australian Government, were aware of this fact at the time of the Competitive Evaluation Process, and remains so today.
\item That group has deliberately cultivated the belief that pumpjet technology, descending directly from French experience with nuclear submarines which no other contender could claim,  would confer a substantial technological edge to Australia's Future Submarine.
\item This belief was known by that group to be false - either because pumpjets would not ultimately be used or their use would be generally disadvantageous - at the same time that is was central to justifying a choice of design partner who's proposal was substantially more expensive and slower to deliver, for which no more defensible reason could be found.
\end{itemize}

In summary, I conclude that the pumpjet was a fraudulent, rather than incompetent proposal, used to construct the fiction that France's heritage as a designer of nuclear submarines offers a substantial technical advantage to a non-nuclear submarine.   In reality, without a nuclear reactor, there is essentially no nuclear-related technology or experience which is usefully transferable to a diesel-electric submarine.  The extent to which the bottom of the barrel needed to be scraped to maintain this fiction was illustrated when RADM Sammut was challenged on the benefit of the nuclear design after facing pressure on the pumpjet, and was forced to refer to the `diameter of the hull' as being a key learning[\ref{SENhanson}].  Given the relatively more accessible engineering concepts involved, such a claim would be much more easily subjected to public ridicule had it been more substantially promoted, as the pumpjet was.\footnote{Among the many engineering challenges presented in designing a new submarine, ensuring the structural integrity of the hull at a new diameter is one of the most well-understood and predictable.  The Collins Class was evolved from a submarine of smaller hull diameter, and this aspect of the design and development encountered no problems.  In 2006, DSTO commissioned a paper suggesting that the Collins Class replacement be designed at a wider hull, which didn't correspond to that of the Barracuda.\parencite{joubert2006}}  In contrast, those countries whose own navies relied entirely upon diesel-electric submarines would likely boast significant advantages in technologies which are genuine game-changers for diesel-electric submarines, such as advanced composite propellers, Air-Independent Propulsion, and Lithium-Ion batteries, which we are now told won't be included in the Future Submarine \textit{because} of the pumpjet\parencite{bergmann2018}.  To that extent, it is almost certain that the pumpjet proposal will not only impose a substantial cost on Australian taxpayers (tens of billions of dollars), but also substantially degrade Australia's future military capability.

In light of these considerations, Defence should be required to explain again what their reasons were for choosing the French as a design partner, as there can now be no doubt that the pumpjet played no legitimate part in it.  The use of a pumpjet will inevitably cause a diesel-electric submarine to have poorer endurance and range, particularly dived endurance and range, and a poorer indiscretion ratio than one with open-tipped propellers.  Any claims to the contrary are made either out of incompetence, as Defence's latest response might have us believe, or are made with the deliberate intent of misleading.
...
\newpage
\section{A chronology of comment}
...
\textit{In a blog post\parencite{costello2016} for the ASPI Strategist prior to the announcement in April, Sean Costello describes the significance of the pump jet technology to their bid.}
\\
\\
...
\textit{In a blog post\parencite{autret2016} for the ASPI Strategist prior to the announcement in April, Sean Costello and Gerard Autret describe a number of the major features and design approaches for the Shortfin Barracuda, including relating the choice of the pumpjet closely to an acoustic requirement to close with another submarine at higher speed.}
\\
\\
...
This comment provides clear context for the importance of the pump-jet.  Consistent with the physics outlined in my earlier paper \parencite{morrison2018} the acoustic advantage is only emphasised by DCNS as being significant at higher speeds.  Whether it is viable for a diesel-electric submarine (as opposed to the nuclear one mentioned here) to maintain such speeds to close with many types of targets is left unclear, or at least unmentioned.  As later discussed in my evidence to the Senate[\ref{SENmorrison}], this is consistent with DCNS being well aware with the advantages and disadvantages of the pumpjet, whilst not making verifiably false claims.
...
The official explanation of the designer and builder's website makes a carefully worded explanation of the superiority of the pumpjet, by limiting the comparison to a ``tactical" encounter with an ``otherwise identical" submarine.  As discussed in[\ref{SENmorrison}], this is the only \textit{possible} target that an elevated speed - such as could be achieved by a diesel-electric submarine - might assist in closing with.  The submarine would be at a substantial `strategic' disadvantage in such an encounter, since its lower dived endurance, dived range, and poorer indiscretion ratio dramatically increases the probability that the pumpjet propelled submarine would wind up being the hunted, rather than the hunter.  More significantly, the speeds achieved would not allow the submarine to close with any other target from behind such as almost all surface ships, or nuclear submarines.  This statement exhibits extreme care in the wording in order to be plausibly defensible, and is arguably misleading.

Read literally, the comparison with `obsolete' propeller technology implies that the pumpjet is only quieter than obsolete propellers, rather than so much more quiet that all propellers that propellers in general are obsolete. This is consistent with my earlier findings. This is also consistent with there being care taken not to make any false claims, whilst still giving a very confident first-impression.

\subsection{RADM Gregory Sammut, Head of SEA 1000 before the Senate}

\begin{tcolorbox}[width=0.9\textwidth, center, colback=red!5!white,colframe=red!75!black, title= \textbf{6 May 2016 - Senate Estimates}]
\textit{Senator Conroy asks Rear Admiral Greg Sammut (then director of SEA 1000) about the propulsion system of the proposed submarine.  Full exchange in \ref{SENsammut2}. Emphasis added.}

\textbf{Senator CONROY:}  The French do not have this propulsion system on a conventional submarine anywhere, do they?

\textbf{Rear Adm. Sammut:}  They do not have a nuclear reactor on a conventional submarine.

\textbf{Senator CONROY:}  No, the propulsion system they are proposing for the Shortfin Barracuda is not powered by diesel; it is only nuclear powered.

\textbf{Rear Adm. Sammut:}  DCNS has proposed to us a conventionally-powered submarine that includes-I think you are trying to get to the form of propeller we are talking about here, Senator.

\textbf{Senator CONROY:}  Yes.

\textbf{Rear Adm. Sammut:}  It is a pump jet, which is what DCNS has said is part of their proposal. That is just one element of the entire propulsion system. We were discussing before the fact that there are many elements to the propulsion system. There is the propeller, there is the motor that drives the propeller and the diesels that charge the battery that drives the motor. All of those factors combined lead to the propulsion system that is fitted to a submarine . When we consider all of those elements we look at what each contributes to the likely noise signature of the submarine and make an assessment about the overall performance of the submarine as far as its stealth is concerned.

\textbf{Senator CONROY:}  I have read that the signature of the nuclear-powered sub with the propulsion system propeller that we are taking is very good at high speed. But at the speeds that a conventional sub will go-which by definition are considerably less than the speeds a nuclear-powered one achieves-there is a difference in the signature. Could you comment on that?

\textbf{Rear Adm. Sammut:}  \textbf{Only to say that there is an impact across all speed ranges of the propulsion system. It does not purely pertain to high speed.}

\textbf{Senator CONROY:}  But what I have read is that the propulsion system is, if you like, designed and attuned to perform against the nuclear-powered aspect, and that they swap the powering out and keep the same propulsion system, but they have not adapted it in any specific way. I am inviting you to comment. The two parts work beautifully together, but the conventional power that we plan to use does not create as successful a signature at the lower speeds-so above 20 knots versus below 20 knots. Would you like to comment?

\textbf{Rear Adm. Sammut:}  Only to say what I said before. There is an advantage across all the speed ranges in the technologies that are being proposed by DCNS. \textbf{You are right: there has to be a degree of adaption of any propeller that is designed for a submarine , whether it is a normal propeller or whether it is a pump jet.} That always has to take place. The principles that underpin the quietness of a pump jet apply in any case.

\end{tcolorbox}

Only weeks after the announcement of the success of the DCNS bid to be the design partner for SEA 1000, specific questions about the speed-suitability of the propulsion system are being raised by senators.  In this particular line of questioning, Senator Conroy implies that the acoustic advantages of the pumpjet may not apply as well at the speeds that a conventional submarine could operate at, which is consistent with findings in my earlier report that the acoustic advantage would essentially be constrained to circumstances where high speeds would cause cavitation on an open propeller. In his responses, RADM Sammut claims that the advantages apply at all speeds.  He also concedes that some modification of the pumpjet will be required for the purpose, in response to a question about the suitability of the speed.  He is not, however, specific about whether it is the speed requirement, or the shape of the hull, which drives this need for adjustment, though the context would seem to imply the former.  He also here clearly discusses a pumpjet as being a special type of propeller, rather than a completely unrelated system which bears no comparison.
...
\\
\\
(End transcription from interview)
\\
\\
``However decisions on forms of propulsion are ultimately a matter for the Australian Government."\parencite{iggulden2017}
\end{tcolorbox}

This crucial concession reveals a very different level of confidence in the pumpjet being suitable for the Australian diesel-electric submarine.  It also gives an important glimpse into the processes that selected the winning bidder, and key technology components, which reveals a clear contradiction between what would have been previously foregone conclusions.  By revealing that the pumpjet has not yet been firmly decided upon, it is directly implied that France's exclusive offer to transfer the pumpjet technology could not have been the real distinguishing feature that elevated that bid above the others.  Simultaneously, the statement that technology choice is a product of the operational requirement makes it clearly implies that the operational requirement has not yet been determined with sufficient precision to make the suitable technology choice clear.  As a ship-builder with ample experience in both technologies, uniquely positioned as having fitted both pumpjets and propellers to both diesel and nuclear submarines, it is remarkable that the performance information transferred prior or during the CEP was not sufficient to allow a decision  on the technology to be made.  Moreover, it also reveals that this was not only the case at the conclusion of the CEP, and remained so well over a year after.


\begin{tcolorbox}[width=0.9\textwidth, center, colback=blue!5!white,colframe=blue!75!black, title= \textbf{25 Oct 2017 - Herve Guillou, CEO Naval Group}]
...
In responding to the evidence produced by Senator Patrick that pumpjets may have an efficiency issue at low speeds, Mr Johnson refers to an `electric shrouded pod' which is used on cruise ships, which he claims is a modification of a pumpjet.  Very little about this section of his testimony seems to have any reference of connection to reality.  Cross-ocean transits regularly occur at higher speeds than 17-18kt, including by cruise ships, which he mentions. These speeds are essentially unreachable (or only extremely briefly sustainable) by a diesel electric submarine.  As pointed out in my evidence to Senate Economic References Committee[\ref{SENmorrison}] I can find no evidence of any cruise ships having any kind of shroud around the tips of their propellers, or bearing any resemblance or relationship to a pumpjet.  In the same session, whilst in Mr Johnson's presence, I pointed out that it appears that Mr Johnson may have confused electric Azipods, which are used on large ocean-going ships such as cruise ships, and the Navy's new LHDs, with pumpjets.  Azipods have open-tipped propellers, and are not remotely related to pumpjets.  So far as I can discern, this particular part of the testimony was made-up entirely impromptu without any knowledge or care for the truth of the matter.  The degree of confidence that we can have in his assurance that the pump-jet will be the optimum approach for the submarine should be considered in light of this.
...
\textit{Senator Patrick inquires about the nature, cost, and conclusions of earlier research into pumpjets undertaken as part of \$214 million worth of ``de-risking" studies already undertaken, as well as the schedule and cost of subsequent research and development of the pumpjet.  Prior research consisted of a single 99 page report obtained via literature review and discussion with experts at a cost of \$68,825.  Ongoing research included \$1.1million spent to date to develop a generic submarine and pumpjet design, computational and analytic models, and validation of these models through experimental studies.  The development and test program is not scheduled to commence until the last quarter of 2018.  Full questions and responses can be found in \ref{QON148}, \ref{QON150}, \ref{QON151}}
\\
\\
...
\begin{tcolorbox}[width=0.9\textwidth, center, colback=black!5!white,colframe=black!75!black, title= \textbf{3 April 2018 - Department of Defence, in response to Question on Notice from Senator Chris Ketter with return date of 3 April 2018}]
\textit{Senator Ketter asks Question 1, referencing specifically Greg Sammut in \parencite{sammut2017} and my paper \parencite{morrison2018} asks specifically whether Defence maintains that the pumpjet can be efficient across the entire speed range. Full question can be found in \ref{QON1}.}
\\
\\
...
This answer to a question again rests on the claim that the influence of the hull means that comparisons and studies such as those referred to in Reference \parencite{morrison2018} can be ignored.  This is a question which will be given a substantial reply in subsequent sections, but even a quick superficial reading reveals alarming levels of over-reach in the answer.  (For instance, a type of ducted propeller known as a decelerating ducted propeller actually \textit{is} a pumpjet, by definition. An entire chapter (5) of the paper to which Defence is supposedly responding \parencite{morrison2018} discusses this at some length.)
...
\begin{tcolorbox}[width=0.9\textwidth, center, colback=black!5!white,colframe=black!75!black, title= \textbf{3 April 2018 - Department of Defence, in response to Question on Notice from Senator Chris Ketter with return date 3 April 2018}]
...
\textit{In an interview that was published in a post\parencite{guillou2017} on the ASPI Strategist the Australian CEO of Naval group explains to Brendan Nicholson why Naval Group is recommending the pumpjet for the Shortfin Barracuda, and answers some critics.}
\\
\\
\textbf{The company building the Navy's 12 new submarines says they'll be the world's first conventional boats big enough to effectively use the company's pump jet propulsion system.} French Naval Group Australia says that its propulsor will prove much quieter than a propeller on the 4,700-tonne submarine it has dubbed the `Shortfin Barracuda'.
\\
\\
...
This is also the first appearance of the argument that the size of the submarine is a crucial factor that makes the pumpjet viable.  It is the closest that Naval Group has come to making a firm statement of faith in the suitability of the technology for the Australian diesel-electric submarine. As I discussed in another blog post in ASPI Strategist \parencite{morrison2018b} shortly afterwards, this is a remarkably concession that is consistent with the physics that I outlined, since the inefficiency of the pumpjet would likely drive demand for additional fuel and batteries (hence size) to meet requirements.  As such, this admission is more of a concession of the detrimental impact of the pumpjet on the submarine.  My reply post was acknowledged on twitter by one former US Navy submariner and submarine enthusiast as an ``Awesome article about pump jet efficiencies and viability".  Naval Group was tagged in the re-tweet, which was subsequently re-tweeted and liked by naval experts, publications, commentators and authors from around the world.
...
Naval Group here steadfastly refuses to offer a clear opinion on the pumpjet. Only months earlier Defence was asked a specific question on notice about whether they thought Naval Group maintained the opinion that a pumpjet was suitable for a diesel-electric submarine.  Clarke's interview on the Strategist, which seemed to be strongest statement of faith from Naval group in the suitability of the pumpjet for a conventional submarine (perhaps in an effort to patch up the notable refusal to answer the question) had been answered publicly by the same person who had just appeared and he was being asked to respond to.  It might have been expected that Mr Clark would at least attempt to demonstrate conviction about the merits of the proposal.  Instead, he described the information that they were supplying as a classified, government-to-government exchange, as if he were an impartial bystander.  No assurance of the proposals superiority, suitability, or viability in any respect was made.
...
This exchange demonstrates a dismissive attitude towards the evidence I had presented, which borders on contempt. The attitude is clearly pervasive and supported in the highest levels of the defence department.  The General Manager Submarines, Stephen Johnson, claims he simply cannot recall what he said about pumpjets being related to pods on cruise ships, despite being physically present in the same room when I pointedly quoted and contradicted him that morning.  This being pointed out, he claimed to simply not to be paying attention, which won the support of the Head of Capability and Sustainment Group, Kim Gillis.  Despite the obvious shock and exclamation of the senators, Mr Gillis went on to attempt to dismiss my evidence as just another opinion which could probably to be dismissed along with 99\% of the others.
...
Echoing RADM Sammut, Dr Kershaw stressed that the pumpjet on a submarine must be designed in conjunction with the hull-form to which it was to be attached.
...
The first feature of this passage is Dr Kershaws's telling remarks about wave-making resistance, and how in the special submarine scenario the efficiency of a propulsor can be considered independent of speed.  This represents a pure, brazen, and obvious falsehood, justified by a seemingly-relevant truth.  It's akin to arguing `camels have to carry two heavy humps on their backs.  Pigs don't have to carry these two heavy humps, which is why they can fly.'  It also directly contradicts the claim made by Stephen Johnson before the Senate, that ``No matter what kind of propeller or propulsion pump jet  you design, it has to be optimised for a particular speed.".

Whilst it is true that deeply submerged bodies do not need to overcome wave-making resistance, all bodies in contact with any fluid must also overcome skin friction, which means that resistance from this source scales with \textit{velocity squared} in almost all circumstances, including for ships.  This is a most fundamental and basic assumption which is absolutely intrinsic to all basic marine propulsion, and should also be understood by essentially anyone who has passed first-year engineering or physics courses. (For instance, see Pages 9 and 10 of Reference \parencite{MAN2017}, or Chapter 12 of Reference \parencite{carlton2007}, or Chapter 3 of Reference \parencite{mollard2011}.) Apart from it being quite an elementary law of physics (the Drag Law), referred to and relied upon in posts such those by Andrew Davies \parencite{davies2017} commenting on this exact question, any substantial reading of the literature focused on the design of pumpjets for fully submerged objects (such as torpedoes or submarines) will also make it abundantly clear, and the special distinction with wave-making resistance (which is crucial for fast-vessels in the process of reaching the plane) is also abundantly clear, and has been well known for a long time \parencite{wislicenus1973} \parencite{henderson1964}.  Further discussion is given in a subsequent section of this paper.
...
``We've invested heavily in our hydrodynamics and hydro-acoustics program over the past 20 years and this is includes the computational models as well as experimental facilities that confirm modelling results," Dr Kershaw said to \textit{ADM}.
...
It is even more shocking in the light of the fact that the CEO of Naval Group Australia, Sean Costello's, publicly boasted about the significance of the ``offer from France to transfer to Australia sovereign control and use of pump-jet propulsion technology" \parencite{costello2016}, and his simultaneous claim (prior to the conclusion of the CEP) in the same that the performance data of the pumpjet are known by Australian government.

It is still more shocking in the light of the then outgoing acting CEO, Brent Clark's further confirmation before a Senate Inquiry \ref{SENmorrison} ``we've been supplying" classified documents on this topic to the Australian Government.

In contrast to the assurance of full technology transfer, the comments by Dr Kershaw in this article reveals the true state of information flow from DCNS.  Apparently, there is still not sufficient information to be confident about the use of the pumpjet, or else such information is being supressed, and consequently decision on whether the pumpjet will even be used still either cannot be made.  Alternatively, one might conclude the decision is being deliberately averted and delayed.

The former view is consistent with some of the statements of Mr Johnson[\ref{SENjohnson}], that the information about the pumpjet performance on the nuclear Barracuda has not yet arrived.  Nor, it would appear, is sufficient theoretical modelling, or scale model testing, or any other confirmatory data sufficient on this pumpjet for DSTG to be clearly persuaded of the suitability of the pumpjet for our submarine, which will have an almost-identical hull.  Whilst simultaneously claiming that efficiency and performance of the pumpjet can't be assessed without the precise form of the hull and the pumpjet being `tuned' together, they admit that they are having to model a `generic' pumpjet, building up from first principals, in order to have sufficient confidence in their own `independent analysis' of the technologies.
...
\subsection{Department of Defence, to Senator Patrick's Questions on Notice}
\begin{tcolorbox}[width=0.9\textwidth, center, colback=black!5!white,colframe=black!75!black, title= \textbf{Sept 2018 - Department of Defence, in response to Question on Notice from Senator Rex Patrick with return date 18 July 2018}]
\textit{Senator Patrick asks a series of questions regarding the technical readiness level (TRL) of various technologies in the Future Submarine Program, and which ones were included or excluded in the French pre-concept design in the CEP. Full questions and answers can be found in Appendix \ref{QON827}.}
\\
\\
\textbf{Question:} What is the Technological Readiness Level (TRL) of the propulsor being advanced for inclusion in the future submarine design.

\textbf{Answer:} The technology to be used in the propulsor for the Future Submarine is assessed to be at TRL 9 noting it has been in operational use since the end of the 1990s on French submarines. The propulsor for the Future Submarine will be based on this technology.
\\
\\
\textbf{Question:} Has an AIP been ruled out as a Future Submarine System in the early design work.

\textbf{Answer:} At this point of the design process, increased battery and recharging capacity is proving more effective than the addition of AIP in meeting Australia's submarine mission requirements.

\end{tcolorbox}

This response to Questions on Notice clearly demonstrates that the technology being referred to for the pumpjet is indeed the in-service design from the Triomphant Class of SSBNs in the French Navy.  There is no conceivable way that any technology at a higher level of readiness than TRL 7 would not have detailed performance data available, across the full range of operating conditions\parencite{DSTG2018a}.  Alternatively, if the proposal is actually to design a new pumpjet ground-up for the radically different operating speed profile, then this answer is almost certainly misleading, as the actual propulsor to be used is probably at TRL 2, or at best TRL 3.  However, as I have argued before the Senate[\ref{SENmorrison}] and in Reference \parencite{morrison2018}, any attempt to develop a pumpjet that is as efficient as a propeller at low speeds is essentially impossible. The elevated pressure (and lower speed) of water at the rotor which allows the superior acoustic performance at high speed \textit{necessitates} the decline in efficiency at low speeds.

The comment regarding AIP also confirms that RADM Sammut's words in the APDR are not simply careless statements to the media or poor reporting, but represent a considered position of Defence - that AIP is still being considered, (i.e. not ruled out) but doesn't currently appear superior in meeting `mission requirements'.  Another clear implication of this statement is that the mission requirements do exist, and are fixed.  If they are not so, then this statement would be most severely misleading.  This response also seems to confirm that a back-to-front design process is indeed in place, whereby the size of the hull is fixed, whilst there is still a large enough portion of the available displacement unallocated that one could consider an AIP system (several hundreds of tonnes) as one of a plurality of options to include.  That Defence requires an \textit{increased} level of batteries in order to meet the requirement can only mean that the previous nominal load of batteries was insufficienct to meet the requirement, or that the plan now is to very substantially exceed the requirement.

As was discussed earlier in this section, the scale of the impact in terms of performance and displacement of major technology choices such as the type of batteries, type of propulsor, and inclusion of AIP is so large that their status would need to be determined very early in pre-concept design, well in advance of the final hull dimensions being finalised.  Otherwise the resultant variation in displacement/performance will result either in a potential engineering catastrophe (of Super-Seasprite proportions, i.e. the vessel doesn't sink and/or float), or a performance outcome that will not even remotely resemble the performance specified in the requirement.
...
It is simply not credible that the Department of Defence can genuinely hold such a utterly  naive belief that is so clearly contradicted by known experience and the most basic and abundant literature on this topic.  Were it the case that the resistance faced by a fully-submerged body was ``essentially constant over speed" then a submarine or torpedo could reach any speed that it liked by applying the same force, and would have unlimited speed.   This would mean that even a diesel submarine would also have unlimited range by virtue of it's ability to reach any speed  that it liked.  This assertion  by defence is so ridiculous that there is no plausible way that it could be genuinely held to be a true by any one of even moderate technical competence.  It is difficult to even believe that it could be held with any confidence by even moderately intelligent adults of little or no technical background who took a mild interest in researching the topic. (Google `Drag Law' and read the Wikipedia article.)  Unless such an extremely level of incompetence pervades every defence official and scientist who were involved in preparing this statement (which was requested directly from Kim Gillis, Head of CASG and Stephen Johnson, General Manager Submarines) is difficult to avoid reaching the conclusion that the statement was given in a state of extreme contempt for the intelligence of the intended reader, and constitutes a deliberate lie and active attempt to mislead.
...
Both Dr David Kershaw, Chief of Maritime Division at DSTG\parencite{kerr2018}, as well as Mr Brent Clark\parencite{clark2018} have both made arguments to the effect of suggesting that it was the Australian submarine's very large size which is what made the pumpjet viable, where it might not be for smaller submarines.  I responded directly to Clark's comments arguing that the size necessitated by the extra fuel and batteries a pumpjet demanded could hardly be counted as an advantage\parencite{morrison2018b}.  However, Dr Kershaw's argument reveals a different take on on why size is important.  His comments make it clear that it is actually the large weight of the pumpjet \textit{itself} rather than the additional fuel and batteries it required, that was significant.

This argument implies that a smaller submarine couldn't adequately provide sufficient buoyancy or balance to support the heavy pumpjet. If the submarine couldn't provide such buoyancy or balance, the consequences would be catastrophic failure, specifically the submarine would tend to either tail-stand, or sink.  It would be unthinkable for a competent manufacturer, conscious of the weight of the pumpjet and such risks, to neglect to account for such risks.  Weights and balances are known and predictable quantities, which could most easily be accounted for in the design of a new submarine.
...
In a clear parallel with the argument that the performance of propulsion systems on submerged bodies is independent of speed because they don't face wave-making resistance, this line of reasoning involves the presentation of a seemingly relevant, comprehensible technical truth which is used to justify a completely blatant technical falsehood.  Even if Dr Kershaw is not familiar with this area of science and is speaking outside his competence, it is difficult to see how such a pattern of argument would occur so consistently by accident.  For Dr Kershaw to genuinely believe in the arguments that he is making here is almost unthinkable.  For him to casually or accidentally make such careless arguments also seems implausibly reckless.  An alternative explanation is that the results of the research already conducted by the government broadly support the conclusions of my own research, and this is well known by Dr Kershaw, and  that these unfortunate statements are being made in a desperate attempt to deflect attention in order to avoid admitting this fact.

\begin{tcolorbox}[width=0.9\textwidth, center, colback=olive!5!white,colframe=olive!75!black, title= \textbf{How a scientist feels being told that the pumpjet is a game-changer for our diesel-electric submarine because it is so large, where it wouldn't make sense on a smaller one}]

\textbf{Bruce:} I'm not sure about using these fat knobbly tires on my road-bike for the cycle tour... No-one else is using such tyres on a road-bike, I think they'd be slow and inefficient.

\textbf{James:} Don't be silly!  Everyone else would love to use fat knobbly tyres on a road-bike, the only reason they can't is that those cyclists themselves are just so slim and athletic, and can't use the knobbly fat knobbly tyres. Bruce, don't you realise that you're the \textit{only} cyclist ever attempting this tour who weights 200kg, roughly three times what most road-cyclists weigh? If a 70kg rider attempted those speeds with fat knobbly tyres, they wouldn't have the weight to stabilise the forces involved, and they'd be thrown off their bicycle in a catastrophic crash which would probably be fatal.  But for fat cyclists such as yourself, fat knobbly tires are a real game-changer!

\textbf{Bruce:}  What about that one lonely guy over there riding on fat knobbly tyres.  He looks like he weighs about 70kg, and he's not having a catastrophic crash, he's just going really slow and looks tired.  Maybe that's why he's sticking to the footpath.

\textbf{James:} Oh...

\textbf{Bruce:} And didn't you also tell me that you tried riding with fat knobbly tires once years ago?  How did you survive the catastrophic crash?
...
In \parencite{defence2018} the following argument was made, which builds on that in Appendix \ref{QON1}:
...
\begin{tcolorbox}[width=0.9\textwidth, center, colback=olive!5!white,colframe=olive!75!black, title= \textbf{How a scientist feels about being told the pumpjet efficiency can't be assessed because it depends on the hull}]

\textbf{Bruce:} I'd like to buy some light, breathable shoes to go running with.

\textbf{James:} Here, have these double-padded, thick-soled, water-poof, steel-capped, all-weather, leather work-boots.

\textbf{Bruce:} But I don't think those shoes would perform well for running... aren't they uncomfortable?

\textbf{James:} Don't you know that shoes have to operate closely in conjunction with socks?  Sometimes socks can get crinkled when running, leading to discomfort.  The thickly padded sole in this boot is designed to alleviate this discomfort, which will help you run faster too!

\textbf{James:} Hmm... actually I've just talked to a few people with similar boots, they all agree they'd be uncomfortable running.

\textbf{Bruce:} How could they know? Their shoes could be similar maybe, but not quite the same.  Besides, they'd all have different types of socks!  Don't you know that boots have to operate closely in conjunction with socks?  My boots are special, they're designed to operate \textit{especially} closely with socks.  It's really impossible to assess them separately.

\textbf{James:} Ok, but I just noticed I'm already wearing the same socks as you, can you tell me how this sock-boot pair works when running?

\textbf{Bruce:} What??! oh... Hey - didn't I just tell you, boots have to operate in close conjunction with socks! Unlike shoes, with boots you can't just choose a pair that suit your purpose and get some socks that match.  Boots are different! The two have to be designed as a pair.  It's impossible to know how they'll perform without designing them together so they can be tuned to one another, and so we'll have to design your socks and boots together at the same time!

\end{tcolorbox}

\subsection{Relative rotative efficiency, $\eta_R$}

It is true that the hull does indeed change the flow of incoming water to a propulsor.  The area behind the vessel, where the water is being slightly dragged along with the ship (or the water is moving less quickly past the vessel, in the vessel's reference frame) is known as the wake.  Since any aft-mounted propulsor has to operate in the wake, (or wake-field as it is often called) it is true that wake is of importance to the design of the propulsor.  What is not true, however, is that this is grounds for disregarding open-water efficiency, or that it was neglected from consideration in the preparation of my report.
...
\includegraphics[width=0.9\linewidth]{roteff1.png}
\caption{}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\linewidth]{roteff2.png}
\caption{}
\end{subfigure}
\caption{Two texts' explanations of the variance between open-water efficiency and behind a hull from (a) page 152 of \parencite{lewis1988} and (b) page 131 of \parencite{carlton2007}}
\label{fig:roteff1.png}
\end{figure}
...
\caption{One text's description of the various types of efficiency from page 14 of \parencite{MAN2017}}
...
\caption{Open-water test results for an accelerating duct illustrate a similar $\eta_0$ as an open propeller, additional thrust is derived from the duct itself $K_{TD}$ at low $J$ values, enhancing efficiency at high speeds.  Images as shown in Reference \parencite{oosterveld1970}.}
...
\caption{Open-water test results for a decelerating duct exhibits a flatter top for the rotor's efficiency, owing to reduced cavitation as speed increases.  However, the duct imposes a substantial negative thrust at higher $J$ values, degrading efficiency at lower speeds.  Images as shown in Reference \parencite{oosterveld1970}.}
...
\caption{(a) At high speeds, the intake of a pumpjet slows the water-flow and raises its pressure, and it subsequently accelerates through the contracting nozzle to form an efficient jet (b) At low speeds, the pressure gradient created by the duct causes some of the water-flow to stop and reverse.  This `flow separation' wastes energy spinning water in circles, and dramatically reduces the system's efficiency.}
...
Having considered in some detail the nature of the three substantive arguments given in opposition to my findings, it is clear that none actually provide any credible evidence to oppose my conclusions.  However, a clear similarity or parallel between the three can be found.  Each of them respectively actually comprise an argument against an obvious and eligible reference point being used to assess the efficiency of the pumpjet.

The argument that resistance is constant for underwater bodies, since they encounter no wave-making resistance, seeks to oppose any use of propulsive data derived from propulsors which might be used on ships, including for highly comparable systems (waterjets), or even directly comparable systems (pumpjets, or decelerating ducted propellers).  This is extremely strange, given how the nature of propulsive tests, and the carefully unitless dimensions created are created specifically for the purpose of making the results transferrable to different situations, including facing different levels of resistance without the source of that resistance being specified.

The argument that the size of the submarine is a game-changer, attempts to dismiss the possibility that any experience with other diesel-electric submarines constitutes and adequate reference-point, which is strange in the extreme given Naval Group's own experience with such experiments.

The argument that the hull and the pumpjet need to be tuned together is clearly an argument that is intended to dismiss the possibility than any other nuclear submarine, including the Barracuda from which the Shortfin Barracuda is derived, serves as an adequate reference point.

It is indeed remarkable that none of the arguments made actually involve pointing to a better reference point than what I have been able to use from open-source literature, or announce that any results from Naval Group directly contradict the findings of my earlier report.  It is a relatively simple proposition that Naval Group, as one of only two countries in the world to have fitted both pumpjets and propellers to both diesel and nuclear submarines, has in its possession the best data possible to serve as reference-points for our submarine.  Detailed modelling, and tank testing from the pumpjet on the Barracuda would certainly provide the best reference, but experience from the in-service Rubis Class (which use propellers) as well as the in-service SSBNs would doubtless also provide adequate data.

As I have argued, I think that there actually are adequate reference points in open-source literature regarding comparable propulsion systems, designed for comparable purposes, employed in relevant and comparable conditions, to gain the necessary level of accuracy to support a broad, but clear conclusion: that propulsive efficiency in pumpjets declines inevitably and substantially at low speeds in a way that propellers do not.

Taking it as given that the French do have possession of adequate and far more detailed performance data, derived from even closer reference points than what I can glean from public literature, one must ask whether that data actually confirms, or contradicts my findings.  Given public claims from DCNS during the CEP that information regarding both the hydrodynamic and acoustic performance of the pumpjet were in Australian government hands in Australia\parencite{costello2016} there can be little doubt Australian officials have access to such information.  Indeed, it would be an inexcusable oversight if they didn't obtain that information during the CEP.

This poses a seemingly irreconcilable tension between the desperate, implausible arguments currently being made by Defence, and the almost certainty that they have quite definitive and reliable results readily available to them.  It is difficult to accept as likely that such desperate and embarrassing arguments are being made because Defence genuinely doesn't know better, if the means to know better are actually so close at hand.  It seems far more probable that Defence actually is in possession of clear, conclusive evidence which broadly supports the conclusions of my report, and is now deliberately concealing that evidence, and attempting to excuse why they have not drawn the obvious conclusions that any sensible person normally would: that a pumpjet is entirely unsuited to a diesel-electric submarine.
...
\begin{wrapfigure}{r}{0.35\textwidth}
  \begin{center}
    \includegraphics[width=0.28\textwidth]{aidan.jpg}
  \end{center}
  \caption{Aidan Morrison}
\end{wrapfigure}

Aidan Morrison is a physicist, entrepreneur and data-scientist who lives in Sydney with his wife Constance.  He graduated from the Australian National University with First Class Honours in Theoretical Particle Physics, and commenced a PhD in Experimental Particle Physics, doing work on the ATLAS Experiment at CERN searching for the Higgs Boson.

He left his PhD incomplete in order to found Rubber Ducky Defence, a start-up dedicated to developing small naval platforms and weapons for swarm warfare, and chose waterjets and pumpjets respectively for the  semi-submersible Swarm Combat Vessel and medium-weight torpedo involved.  Rubber Ducky responded to Requests for Proposal (RFPs) for SEA 1778 and JP 1770, by adapting this vessel to meet a requirement for deployable mine-countermeasures and rapid environmental assessment.  This requirement included towing and deploying a range of fully-submerged sensors, decoys, remotely and autonomously operated underwater vehicles in a variety of speeds to meet the specified conceptual operations.  Endurance and range were crucial considerations in responding to the Preliminary Function and Performance Specifications for these two projects.  A detailed proposal evolved from this concept and submitted to DSTO's Concept Technology Demonstrator program in 2013 was acknowledged as ``probably a world-class development".

His other accomplishments include co-founding a bar-restaurant in Randwick called Bat Country, and developing a predictive forecasting tool for hospitality businesses using machine-learning techniques under Trendlock, which also undertakes additional consulting services.  He has also lead a team of economic analysts at boutique think-tank, and currently works as a data-scientist at Tridant, most recently using machine-learning and statistical techniques to implement predictive maintenance routines for heavy industrial machinery.
...
\textbf{Rear Adm. Sammut:}   We have selected Naval Group as competent designers of diesel electric
...
\textbf{Senator CONROY:}  Okay. I want you to pretend that I know absolutely nothing about what I am going to ask next, which should be easy because it is true. It is very easy for him to fake this, because it is true. There has been a lot of debate in the papers about the propulsion system—the French versus anybody else's. Could you tell us about the propulsion system, because there has been a lot of adverse discussion about it. I am interested in your perspective. Without revealing anything that you should not, are you able to explain to the committee?

\textbf{Rear Adm. Sammut:}  We looked at the propulsion system, of course, offered by all participants. The propulsion system includes a range of systems in the submarine designed to propel it through the water and to do so quietly. Propulsion for any submarine , of course, has a large bearing on its stealth—in other words, how quietly the submarine moves through the water. We considered all of the proposals presented by the participants using a range of subject matter experts. It included assessment by the Defence Science and Technology Group, and we looked not only at what was proposed by participants, in terms of what sort of propeller they would put on the submarine and what sort of drive train they would have, but also at what their response was in terms of the performance of those systems. In the final analysis, we decided that the DCNS proposal best met our requirements for stealth based on our understanding of what would be required of a regionally superior submarine operating in the 2030s and beyond.

\textbf{Senator CONROY:}  Thank you. I have been reading—as you would hope and expect—as much of the commentary as I can keep up with on this. The current French propulsion system is propelled by a nuclear engine. Is that the current Barracuda?

\textbf{Rear Adm. Sammut:}  The submarine they are designing and building for themselves is a nuclear-powered submarine .

\textbf{Senator CONROY:}  So it is a nuclear reactor that drives the propulsion system?

\textbf{Rear Adm. Sammut:}  That is correct.

\textbf{Senator CONROY:}  I think the Prime Minister said this, but can I just confirm from the expert panel:  there was no consideration, and this was not a factor in any way whatsoever, about this mooted change to a nuclear submarine halfway through the process. I am inviting you to confirm that this bore no part whatsoever in the thinking of your group, you or any of the other partners.

\textbf{Rear Adm. Sammut:}  I can confirm that categorically.

\textbf{Senator CONROY:}  So if at some stage over the life build of the 12 we ended up with a nuclear sub as part of this process, it would be a mystery to you?

\textbf{Rear Adm. Sammut:}  The competitive evaluation process was about the acquisition of a future submarine that was conventionally powered. That was purely the consideration upon which the proposals were assessed.

\textbf{Senator CONROY:}  I understand the propulsion system of the French proposal is rumoured—again, if there are areas you cannot disclose, please say so—to work brilliantly quietly with the nuclear reactor at high speeds. It is very quiet. Is that correct?

\textbf{Rear Adm. Sammut:}  The performance of all submarines operating at high speeds is largely about the manner in which the propeller works, somewhat independently of what is supplying power to the propeller.

\textbf{Senator CONROY:}  But I understand one of the proud claims from DCNS of its nuclear-powered Barracuda is that at high speed with its nuclear-powered propulsion system it is very quiet in a submarine underwater signature sense.

\textbf{Rear Adm. Sammut:}  The French would have goals, of course, for the noise performance of its submarines. I should add that it is not related just to the propulsion system but to the way the hull is designed, the flow of the water over the hull at those high speeds and how that is managed to reduce flow noise that emanates from the submarine at high speeds.
...
\textbf{Rear Adm. Sammut:}  Only to say that there is an impact across all speed ranges of the propulsion system. It does not purely pertain to high speed.

\textbf{Senator CONROY:}  But what I have read is that the propulsion system is, if you like, designed and attuned to perform against the nuclear-powered aspect, and that they swap the powering out and keep the same propulsion system, but they have not adapted it in any specific way. I am inviting you to comment. The two parts work beautifully together, but the conventional power that we plan to use does not create as successful a signature at the lower speeds—so above 20 knots versus below 20 knots. Would you like to comment?

\textbf{Rear Adm. Sammut:}  Only to say what I said before. There is an advantage across all the speed ranges in the technologies that are being proposed by DCNS. You are right: there has to be a degree of adaption of any propeller that is designed for a submarine , whether it is a normal propeller or whether it is a pump jet. That always has to take place. The principles that underpin the quietness of a pump jet apply in any case.
...
\begin{figure}[h]
\includegraphics[width=0.7\textwidth, center]{QON148.png}
\end{figure}
...
Pumpjet design had advanced over many years with a particular focus on the characteristics of all the components, although much of that was classified.
...
So will pump jet technology definitely be used for the Future Submarine?
``That is what is currently in the design  and that's what a lot of our science and technology program is about; having the capability to do the independent analysis on the technologies and capabilities planned for the Future Submarine, including the pump jet program," Dr Kershaw said to \textit{ADM}.
...
\subsection{Answer to Question on Notice}\label{QON827}

\begin{figure}[h]
\includegraphics[width=0.7\textwidth, center]{QON827a.png}
\end{figure}

\newpage

\begin{figure}[h]
\includegraphics[width=0.7\textwidth, center]{QON827b.png}
\end{figure}
