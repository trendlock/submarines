...
After the initial publication of my first report, three Questions on Notice were asked by Senator Ketter, specifically referencing my report[\ref{QON1}, \ref{QON2}, \ref{QON3}].  Whilst Defence avoiding answering all of them directly, one of them was particularly brazenly side-stepped.  Asked ``Is Defence still confident that Naval Group still hold the opinion that the pump-jet is well suited to diesel-electric submarines?" Defence merely reiterated their intent is to use the pumpjets as offered, strictly avoiding mentioning anyone's opinion, either their own or Naval Group's.  If the answer actually was what we would all assume it should be, that would have been a very easy question to answer directly.  A simple `yes' would be sufficient.  If the answer was `no', then we must assume that at the time of writing (presumably before the return date of 3 April, though Defence isn't always timely) that Defence had an inkling (at the very least) of what Naval Group undoubtedly knew all along - that pumpjets are entirely unsuitable for diesel-electric submarines.  In avoiding answering the question directly, Defence was not just misleading the Parliament, but clearly acting to shelter Naval Group from subsequent questions about fraudulent or misleading conduct during the CEP.

Giving Defence the most generous possible interpretation, one might allow the possibility that Defence were just coming to grips with being completely hood-winked during the CEP by their chosen design-partner, and perhaps felt that their wrath at being deliberately deceived ought not be publicly vented, or at least not at this stage.  One might, at a stretch, allow that maintaining the opportunity for the partner to save-face was still a useful bargaining-chip that our Defence chiefs to use in order to bring a potentially treacherous contractor to heel. (Presumeably in addition to a range of contractual penalties, as well as the commercial leverage the Commonwealth would have by being able to re-introduce competition into the design process as many have suggested ought be done in any case \parencite{stanford2017}, or simply not proceed to a build contract on completion of the design.)

The state of commercial negotiations between the Commonwealth and Naval Group, as revealed in the Senate Economic References Committee \parencite{SEN2018morrison}, show that Defence was moving in exactly the opposite direction - shocking Senators with the revelation that Defence was looking instead to contract immediately with DCNS for the full construction of all 12 submarines, to the complete exclusion of the Australian Submarine Corporation, within coming months as part of the Strategic Partnering Agreement.  This would effectively wipe out the opportunity for any competitive tension at any stage of the \$79 billion five-decade project within the first two years of a five-year design phase.
...
\begin{tcolorbox}[width=0.9\textwidth, center, colback=green!5!white,colframe=green!75!black, title= \textbf{How a scientist feels being told that the pumpjet is a game-changer for our diesel-electric submarine because it is so large, where it wouldn't make sense on a smaller one}]
