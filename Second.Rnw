...
\textit{In a blog post\parencite{autret2016} for the ASPI Strategist prior to the announcement in April, Sean Costello describes a number of the major features and design approaches for the Shortfin Barracuda, including relating the choice of the pumpjet closely to an acoustic requirement to close with another submarine at higher speed.}
\\
\\
...
This answer to a question again rests on the claim that the influence of the hull means that comparisons and studies such as those referred to in \parencite{morrison2018} can be ignored.  This is a question which will be given a substantial reply in subsequent sections, but even a quick reading superficial reading reveals alarming levels of over-reach in the answer.  (For instance, a type of ducted propeller known as a decelerating ducted propeller actually \textit{is} a pumpjet, by definition. An entire chapter (5) of the paper to which Defence is supposedly responding \parencite{morrison2018} discusses this at some length.)
...
In contrast to Mr Johnson's inference that my report might be made `without contemporary knowledge or without understanding necessarily the intricacy', his own comments on powering requirements of ships, just like the propulsive pods for ships, demonstrate a complete disregard or ignorance of the most basic and fundamental concepts relevant.
...
Bruce: I'm not sure about using these fat knobbly tires on my road-bike for the cycle tour... No-one else is using such tyres on a road-bike, I think they'd be slow and inefficient.

James: Don't be silly!  Everyone else would love to use fat knobbly tyres on a road-bike, the only reason they can't is that those cyclists themselves are just so slim and athletic, and can't use the knobbly fat knobbly tyres. Bruce, don't you realise that you're the \textit{only} cyclist every attempting this tour who weights 200kg, roughly three times what most road-cyclists weigh? If a 70kg rider attempted those speeds with fat knobbly tyres, they wouldn't have the weight to stabilise the forces involved, and they'd be thrown off their bicycle in a catastrophic crash which would probably be fatal.  But for fat cyclists such as yourself, fat knobbly tires are a real game-changer!

Bruce:  What about that one lonely guy over there riding on fat knobbly tyres.  He looks like he weighs about 70kg, and he's not having a catastrophic crash, he's just going really slow and looks tired.  Maybe that's why he's sticking to the footpath.

James: Oh...

Bruce: And didn't you also tell me that you tried riding with fat knobbly tires once years ago?  How did you survive the catastrophic crash?
...
Bruce: I'd like to buy some light, breathable shoes to go running with.

James: Here, have these double-padded, thick-soled, water-poof, steel-capped, all-weather, leather work-boots.

Bruce: But I don't think those shoes would perform well for running... aren't they uncomfortable?

James: Don't you know that shoes have to operate closely in conjunction with socks?  Sometimes socks can get crinkled when running, leading to discomfort.  The thickly padded sole in this boot is designed to alleviate this discomfort, which will help you run faster too!
...
Having considered in some detail the nature of the three substantive arguments given in opposition to my findings, it is clear that none actually provide any credible evidence to oppose my conclusions.  However, a clear similarity or parallel between the three can be found.  Each of them respectively actually comprise an argument against an obvious reference point being used to assess the efficiency of the pumpjet.

The argument that resistance is constant for underwater bodies, since they encounter no wave-making resistance, seeks to oppose any use of propulsive data derived from propulsors which might be used on ships, including for highly comparable systems (waterjets), or even directly comparable systems (pumpjets, or decelerating ducted propellers).

The argument that the size of the submarine is a game-changer, attempts to dismiss the possibility that any experience with other diesel-electric submarines constitutes and adequate reference-point.
...
As I have argued, I think that there actually are adequate reference points in open-source literature regarding comparable propulsion systems, designed for comparable purposes, employed in relevant and comparable, in order to gain what is really only a very broad, but clear conclusion: that propulsive efficiency declines inevitably and dramatically at low speeds.

Taking it as given that the French do have possession of adequate of far more detailed performance data, derived from even closer reference points than what I can glean from public literature, one must ask whether that data actually confirms, or contradicts my findings.  Given public claims from DCNS during the CEP that information regarding both the hydrodynamic and acoustic performance of the pumpjet were in Australian government hands in Australia \parencite{costello2016} there can be little doubt Australian officials have access to such information.  Indeed, it would be an inexcusable oversight if they didn't obtain that information during the CEP.

This poses a seemingly irreconcilable tension between the desperate, implausible arguments currently being made by Defence, and the possibility that they are being made because Defence genuinely doesn't know better, and genuinely believes them to be true.  It seems far more probable that Defence actually is in possession of clear, conclusive evidence which broadly supports the conclusions of my report, and is now deliberately concealing that evidence, and attempting to excuse why they have not drawn the obvious conclusions that any sensible person normally would from that evidence - that a pumpjet is entirely unsuited to a diesel-electric submarine.
